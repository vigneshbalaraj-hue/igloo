...
function Navbar() {
  ...
  return (
    <nav ref={ref} className={`fixed top-6 left-1/2 -translate-x-1/2 z-40 px-2 py-2 rounded-full flex items-center gap-1 transition-all duration-500 ${
      ...
      <a href="https://igloo.video/create" className="btn-magnetic ml-2 px-5 py-2 bg-amber text-void text-sm font-semibold rounded-full hover:bg-amber-hover">
        Create Your Reel
      </a>
    </nav>
  )
    ...
    <section ref={heroRef} className="relative min-h-[100dvh] flex items-end overflow-hidden">
      ...
      <div className="relative z-10 max-w-[700px] px-8 md:px-16 pb-20 md:pb-28">
        ...
        <div className="hero-cta flex flex-wrap gap-4">
          <a href="https://igloo.video/create" className="btn-magnetic inline-flex items-center gap-3 px-8 py-4 bg-amber text-void font-bold rounded-2xl text-base hover:bg-amber-hover hover:shadow-[0_8px_40px_rgba(217,119,6,0.3)]">
  ...
  return (
    <section ref={ref} className="relative py-32 md:py-44 px-6 md:px-16 overflow-hidden">
      ...
      <div className="cta-content relative max-w-[700px] mx-auto text-center">
        ...
        <a href="https://igloo.video/create" className="btn-magnetic inline-flex items-center gap-3 px-10 py-5 bg-amber text-void font-bold rounded-2xl text-lg hover:bg-amber-hover hover:shadow-[0_12px_48px_rgba(217,119,6,0.35)]">
